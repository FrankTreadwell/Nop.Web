...
using Nop.Admin.Models.Variants;
...
namespace Nop.Admin.Controllers
{
    public partial class ProductController : BaseAdminController
    {
        ...
        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
        public ActionResult CreateWithImages(ProductModel model, bool continueEditing)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageProducts))
                return AccessDeniedView();
        ...
        public ActionResult Edit(int id)
        {
            ...
            var variants = GetALLVariants(model.Id);
            return View(model);
        }
        ...
        [HttpPost]
        public List<ProductVariantAttribute> GetALLVariants(int productid)
        {
            //_productAttributeService.
            var x = _productAttributeService.GetProductVariantAttributesByProductId(productid);
